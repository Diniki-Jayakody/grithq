...
export const STRINGS = {
  ...
  sections: {
    ...
    impact: {
      ...
      emphasis: 'It is measured in lives touched.',
      whyWeGive: 'Why We Give',
      feedingFutures: 'Feeding Futures',
    ...
    contact: {
      ...
      submitSuccess: 'Thank you. We will be in touch.',
    },
  },
  ...
  identity: {
    principles: [
      ...
      },
      {
        number: '03',
        title: 'STEWARDSHIP',
        text: 'We approach capital, partnerships and communities with responsibility and integrity.',
      },
    ],
    investmentFocus: {
      ...
      approach: {
        ...
        steps: [
          {
            title: 'IDENTIFY',
            description: 'Opportunities with meaningful potential.',
          },
          {
            title: 'ASSESS',
          ...
          {
            title: 'INVEST',
            description: 'Disciplined capital aligned with conviction.',
          },
          {
            title: 'BUILD',
